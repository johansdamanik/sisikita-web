  ...
  <div class="min-h-screen flex items-center justify-center px-4 py-12 bg-neutral-50">
    <div class="w-full max-w-md">
      <div class="text-center mb-8">
        ...
        <h1 class="text-2xl font-bold text-neutral-900 mb-2">Buat Akun Baru</h1>
        <p class="text-neutral-700">Sudah punya akun? <NuxtLink to="/login" class="text-primary font-semibold hover:underline">Masuk</NuxtLink></p>
      </div>

      <form @submit.prevent="handleRegister" class="bg-white rounded-2xl shadow-[var(--shadow-card)] border border-neutral-200/50 p-8">
        ...
        <div class="space-y-5">
          ...
          <div>
            <label for="confirmPassword" class="block text-sm font-medium text-neutral-900 mb-1.5">Konfirmasi Password</label>
            <input
              id="confirmPassword"
...
useSeoMeta({ title: 'Daftar — SisiKita' })
...
async function handleRegister() {
  ...
  try {
    ...
    error.value = e?.data?.message || 'Gagal membuat akun. Coba lagi.'
  }
}
</script>
